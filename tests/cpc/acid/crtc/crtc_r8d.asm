...
;; type 0: 7ed-7e9 it goes direct to vadj,  (doesn't happen during vadj though)
; verify: r8 effect happens during vadj?
;; just 1 scanline like in 8b
;; type 1: happens during vadj same as 8b/8c does.
;; type 2: same as 8b/8c 
;; type 3: same as 8b and happens during vadj
ld bc,&7f00
out (c),c
ld de,&544b
out (c),e
