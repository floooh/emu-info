...
;; type 0: r6 changes immediately and works in vertical adjust all the way to end of 
;; vertical adjust indicating it's just 1 char line
;; type 1: r6 changes immediately and works in vertical adjust for first char line only.
;; type 2: same as type 1
;; type 3: no change
;;
;;  when border is triggered it continues for whole frame
