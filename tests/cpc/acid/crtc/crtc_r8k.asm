...
;; type 0: 790 flicker rate increases of white line,  730-72c 1 whole line flicker on/off and vsync moves by 1 line
;; 
;; type 1: nothing
;; type 2:730 vsync pos happens a little bit later (couple of pixels)
;; 7e2 vsync occurs 4 chars later. 72c vsync 8 chars later
;; 
;; type 3:73d-72a approx jumps slighly.r8 like
