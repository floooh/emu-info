...
;; bc04 = 0 and bc09=1, count is fine, single line repeats
;; bc09 = 0 and bc04!=0, count is fine, 4 on screen 1 line each
;; bc09=0 and bc04=0, r4 seems to overflow but not always, sometimes just blank
;; seems to work on HD68454R
;;bc00,7,bd00,0
;;bc00,4,bd00,0 causes crash on kc compact??
loop:
jp loop
